...
<script lang="ts">
import { Vue, Component, Prop, Provide, Inject, Emit } from 'vue-property-decorator'
import { mapState, mapGetters } from 'vuex'
// import TopBar from '../widgets/topbar'
// import Nav from '../widgets/navbar'

export default class HeaderHeader9 extends Vue {
  @Inject() currencyChange!: {}
  @Inject() search: boolean = false
  @Inject() readonly searchString!: string

  @Emit()
  getImgUrl(url: string) { return require('@/assets/images/' + url) }
  ...
  @Emit()
  searchProduct() { this.$store.dispatch('products/searchProduct', this.searchString) }

  @Emit()
  removeCartItem( product: any ){ this.$store.dispatch('cart/removeCartItem', product) }
